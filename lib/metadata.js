...
export function generateMetadata(pageName, additionalData = {}) {
  ...
  const pageMetadata = {
    home: {
      ...
      keywords: 'AI Automation Agency India, Custom SaaS Development Company India, ERP Software Development India, Web Development Company Mumbai Delhi Bangalore, Mobile App Development Agency India, Hire AI Developers India, Best IT Services Company India, B2B Software Agency India, IT companies near me, IT agency Near me, Software companies near me , Software company india , AI AUtomation, web developer , development ',
      openGraph: {
        title: 'Top AI Automation & Custom Software Development Agency in India | ASH Solutions',
