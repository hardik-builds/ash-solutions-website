...
export function generateMetadata(pageName, additionalData = {}) {
  ...
  const pageMetadata = {
    home: {
      ...
      description: 'Enhance your digital presence, performance, and scalability with our integrated services in web development, SEO, game development, and app development.',
      keywords: 'web development, SEO optimization, game development, app development, cloud solutions, digital solutions, business technology',
      openGraph: {
    ...
    about: {
      ...
      description: 'Learn more about ASH Solutions, a smart and integrated web platform providing advanced digital solutions in web development, cloud solutions, SEO, and more.',
    ...
    services: {
      ...
      description: 'Explore our comprehensive range of digital services including web development, SEO optimization, game development, app development, and cloud solutions.',
      keywords: 'web development services, SEO services, game development services, app development services, cloud solutions',
      openGraph: {
        title: 'Our Services - ASH Solutions',
    ...
    pricing: {
      ...
      description: 'View our competitive pricing plans for web development, SEO optimization, game development, app development, and cloud solutions.',
      keywords: 'pricing plans, web development pricing, SEO pricing, service costs',
      openGraph: {
        title: 'Pricing Plans - ASH Solutions',
    ...
    insights: {
      title: 'Insights - ASH Solutions',
      description: 'Explore our latest case studies, blogs, and client reviews to see how we deliver value.',
      keywords: 'case studies, blogs, reviews, client testimonials, insights',
      openGraph: {
        title: 'Insights - ASH Solutions',
        description: 'Read our latest blogs, case studies, and client reviews.',
